...
class Register extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://api-smartbrain.herokuapp.com/register', {
            method: 'post',
        ...
        return (
            ...
            <main className="pa4 black-90">
                <div className="measure ">
                    ...
                    <p onClick={() => onRouteChange('signin')} className="f6 link dim black db pointer">Already have an account? SignIn</p>
                    </div>
                </div>
            </main>
            </article>
